...
{
    public partial class UI_BtnTreeItem : GButton
    {
        ...
        public static UI_BtnTreeItem CreateInstance()
        {
            return (UI_BtnTreeItem)UIPackage.CreateObject("NextCore", "BtnTreeItem");
        }

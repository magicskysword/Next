...
{
    public class CtlIntBindDataPropertyDrawer : CtlPropertyDrawerBase
    {
        ...
        public CtlIntBindDataPropertyDrawer(string drawerName, Action<int> setter, Func<int> getter,

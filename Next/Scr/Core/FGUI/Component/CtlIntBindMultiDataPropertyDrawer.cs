...
{
    public class CtlIntBindMultiDataPropertyDrawer : CtlPropertyDrawerBase
    {
        ...
        public CtlIntBindMultiDataPropertyDrawer(string drawerName, Action<List<int>> setter, Func<List<int>> getter,

...
{
    public class CtlIntBindMultiDataCtlPropertyDrawer : CtlPropertyDrawerBase
{
    ...
    public CtlIntBindMultiDataCtlPropertyDrawer(string drawerName,Action<List<int>> setter,Func<List<int>> getter,

...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITextFieldLineCharInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.TextField.LineCharInfo);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(FairyGUI.TextField.LineCharInfo));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.TextField.LineCharInfo constructor!");
        ...
        static int _g_get_width(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.TextField.LineCharInfo gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);

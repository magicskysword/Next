        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new FairyGUI.GTween();
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = FairyGUI.GTween.To( _startValue, _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = FairyGUI.GTween.ToDouble( _startValue, _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _delay = (float)LuaAPI.lua_tonumber(L, 1);
                        ...
                        var gen_ret = FairyGUI.GTween.DelayedCall( _delay );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = FairyGUI.GTween.Shake( _startValue, _amplitude, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<object>(L, 1)) 
                {
                    object _target = translator.GetObject(L, 1, typeof(object));
                        ...
                        var gen_ret = FairyGUI.GTween.IsTweening( _target );
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 1)&& translator.Assignable<FairyGUI.TweenPropType>(L, 2)) 
                {
                    ...
                    FairyGUI.TweenPropType _propType;translator.Get(L, 2, out _propType);
                        ...
                        var gen_ret = FairyGUI.GTween.IsTweening( _target, _propType );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<object>(L, 1)) 
                {
                    object _target = translator.GetObject(L, 1, typeof(object));
                        ...
                        var gen_ret = FairyGUI.GTween.GetTween( _target );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 1)&& translator.Assignable<FairyGUI.TweenPropType>(L, 2)) 
                {
                    ...
                    FairyGUI.TweenPropType _propType;translator.Get(L, 2, out _propType);
                        ...
                        var gen_ret = FairyGUI.GTween.GetTween( _target, _propType );
                        translator.Push(L, gen_ret);

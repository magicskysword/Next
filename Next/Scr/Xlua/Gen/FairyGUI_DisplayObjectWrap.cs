        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new FairyGUI.DisplayObject();
		    ...
		    try {
                ...
                
                {
                    ...
                    float _scale = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.GetScreenShot( _extend, _scale );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.DisplayObject _targetSpace = (FairyGUI.DisplayObject)translator.GetObject(L, 2, typeof(FairyGUI.DisplayObject));
                        ...
                        var gen_ret = gen_to_be_invoked.GetBounds( _targetSpace );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector2 _point;translator.Get(L, 2, out _point);
                        ...
                        var gen_ret = gen_to_be_invoked.GlobalToLocal( _point );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector2 _point;translator.Get(L, 2, out _point);
                        ...
                        var gen_ret = gen_to_be_invoked.LocalToGlobal( _point );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _direction;translator.Get(L, 3, out _direction);
                        ...
                        var gen_ret = gen_to_be_invoked.WorldToLocal( _worldPoint, _direction );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _localPoint;translator.Get(L, 2, out _localPoint);
                        ...
                        var gen_ret = gen_to_be_invoked.LocalToWorld( _localPoint );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    FairyGUI.DisplayObject _targetSpace = (FairyGUI.DisplayObject)translator.GetObject(L, 3, typeof(FairyGUI.DisplayObject));
                        ...
                        var gen_ret = gen_to_be_invoked.TransformPoint( _point, _targetSpace );
                        translator.PushUnityEngineVector2(L, gen_ret);

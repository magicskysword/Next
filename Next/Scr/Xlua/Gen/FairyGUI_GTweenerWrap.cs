        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new FairyGUI.GTweener();
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetDelay( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetDuration( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetBreakpoint( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.EaseType>(L, 2)) 
                {
                    FairyGUI.EaseType _value;translator.Get(L, 2, out _value);
                        ...
                        var gen_ret = gen_to_be_invoked.SetEase( _value );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<FairyGUI.EaseType>(L, 2)&& translator.Assignable<FairyGUI.CustomEase>(L, 3)) 
                {
                    ...
                    FairyGUI.CustomEase _customEase = (FairyGUI.CustomEase)translator.GetObject(L, 3, typeof(FairyGUI.CustomEase));
                        ...
                        var gen_ret = gen_to_be_invoked.SetEase( _value, _customEase );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetEasePeriod( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetEaseOvershootOrAmplitude( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _yoyo = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.SetRepeat( _times, _yoyo );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    int _times = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetRepeat( _times );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetTimeScale( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    bool _value = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetIgnoreEngineTimeScale( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    bool _value = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetSnapping( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GPath _value = (FairyGUI.GPath)translator.GetObject(L, 2, typeof(FairyGUI.GPath));
                        ...
                        var gen_ret = gen_to_be_invoked.SetPath( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 2)) 
                {
                    object _value = translator.GetObject(L, 2, typeof(object));
                        ...
                        var gen_ret = gen_to_be_invoked.SetTarget( _value );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<object>(L, 2)&& translator.Assignable<FairyGUI.TweenPropType>(L, 3)) 
                {
                    ...
                    FairyGUI.TweenPropType _propType;translator.Get(L, 3, out _propType);
                        ...
                        var gen_ret = gen_to_be_invoked.SetTarget( _value, _propType );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    object _value = translator.GetObject(L, 2, typeof(object));
                        ...
                        var gen_ret = gen_to_be_invoked.SetUserData( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.GTweenCallback>(L, 2)) 
                {
                    FairyGUI.GTweenCallback _callback = translator.GetDelegate<FairyGUI.GTweenCallback>(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.OnUpdate( _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.GTweenCallback>(L, 2)) 
                {
                    FairyGUI.GTweenCallback _callback = translator.GetDelegate<FairyGUI.GTweenCallback>(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.OnComplete( _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.ITweenListener _value = (FairyGUI.ITweenListener)translator.GetObject(L, 2, typeof(FairyGUI.ITweenListener));
                        ...
                        var gen_ret = gen_to_be_invoked.SetListener( _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    bool _paused = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.SetPaused( _paused );
                        translator.Push(L, gen_ret);

        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new FairyGUI.GRoot();
        ...
        static int _m_GetTopWindow(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetTopWindow(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.DisplayObject _obj = (FairyGUI.DisplayObject)translator.GetObject(L, 2, typeof(FairyGUI.DisplayObject));
                        ...
                        var gen_ret = gen_to_be_invoked.DisplayObjectToGObject( _obj );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    FairyGUI.PopupDirection _dir;translator.Get(L, 4, out _dir);
                        ...
                        var gen_ret = gen_to_be_invoked.GetPoupPosition( _popup, _target, _dir );

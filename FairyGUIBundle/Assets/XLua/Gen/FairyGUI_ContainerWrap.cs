        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new FairyGUI.Container();
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					var gen_ret = new FairyGUI.Container(_gameObjectName);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.GameObject>(L, 2))
				{
					...
					var gen_ret = new FairyGUI.Container(_attachTarget);
					translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    bool _backward = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetDescendants( _backward );
        ...
        static int _m_GetRenderCamera(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetRenderCamera(  );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _forTouch = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.HitTest( _stagePoint, _forTouch );
                        translator.Push(L, gen_ret);

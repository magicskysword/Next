...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetSnappingPosition", _m_GetSnappingPosition);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetSnappingPositionWithDir", _m_GetSnappingPositionWithDir);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Transitions", _g_get_Transitions);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSnappingPosition(RealStatePtr L)
        {
		    try {
                ...
                {
                    float _xValue = (float)LuaAPI.lua_tonumber(L, 2);
                    float _yValue = (float)LuaAPI.lua_tonumber(L, 3);
                    
                    gen_to_be_invoked.GetSnappingPosition( ref _xValue, ref _yValue );
                    LuaAPI.lua_pushnumber(L, _xValue);
                        
                    LuaAPI.lua_pushnumber(L, _yValue);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSnappingPositionWithDir(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    float _xValue = (float)LuaAPI.lua_tonumber(L, 2);
                    float _yValue = (float)LuaAPI.lua_tonumber(L, 3);
                    float _xDir = (float)LuaAPI.lua_tonumber(L, 4);
                    float _yDir = (float)LuaAPI.lua_tonumber(L, 5);
                    
                    gen_to_be_invoked.GetSnappingPositionWithDir( ref _xValue, ref _yValue, _xDir, _yDir );
                    LuaAPI.lua_pushnumber(L, _xValue);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Transitions(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GComponent gen_to_be_invoked = (FairyGUI.GComponent)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Transitions);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;

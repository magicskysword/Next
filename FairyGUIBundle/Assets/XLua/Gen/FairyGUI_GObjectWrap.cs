        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new FairyGUI.GObject();
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetGear( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector2>(L, 2)) 
                {
                    UnityEngine.Vector2 _pt;translator.Get(L, 2, out _pt);
                        ...
                        var gen_ret = gen_to_be_invoked.LocalToGlobal( _pt );
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Rect>(L, 2)) 
                {
                    UnityEngine.Rect _rect;translator.Get(L, 2, out _rect);
                        ...
                        var gen_ret = gen_to_be_invoked.LocalToGlobal( _rect );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector2>(L, 2)) 
                {
                    UnityEngine.Vector2 _pt;translator.Get(L, 2, out _pt);
                        ...
                        var gen_ret = gen_to_be_invoked.GlobalToLocal( _pt );
                        translator.PushUnityEngineVector2(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Rect>(L, 2)) 
                {
                    UnityEngine.Rect _rect;translator.Get(L, 2, out _rect);
                        ...
                        var gen_ret = gen_to_be_invoked.GlobalToLocal( _rect );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    FairyGUI.GRoot _r = (FairyGUI.GRoot)translator.GetObject(L, 3, typeof(FairyGUI.GRoot));
                        ...
                        var gen_ret = gen_to_be_invoked.LocalToRoot( _pt, _r );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    FairyGUI.GRoot _r = (FairyGUI.GRoot)translator.GetObject(L, 3, typeof(FairyGUI.GRoot));
                        ...
                        var gen_ret = gen_to_be_invoked.RootToLocal( _pt, _r );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _pt;translator.Get(L, 2, out _pt);
                        ...
                        var gen_ret = gen_to_be_invoked.WorldToLocal( _pt );
                        translator.PushUnityEngineVector2(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Camera>(L, 3)) 
                {
                    ...
                    UnityEngine.Camera _camera = (UnityEngine.Camera)translator.GetObject(L, 3, typeof(UnityEngine.Camera));
                        ...
                        var gen_ret = gen_to_be_invoked.WorldToLocal( _pt, _camera );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    FairyGUI.GObject _targetSpace = (FairyGUI.GObject)translator.GetObject(L, 3, typeof(FairyGUI.GObject));
                        ...
                        var gen_ret = gen_to_be_invoked.TransformPoint( _pt, _targetSpace );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    FairyGUI.GObject _targetSpace = (FairyGUI.GObject)translator.GetObject(L, 3, typeof(FairyGUI.GObject));
                        ...
                        var gen_ret = gen_to_be_invoked.TransformRect( _rect, _targetSpace );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenMove( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenMoveX( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenMoveY( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenScale( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenScaleX( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenScaleY( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenResize( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenFade( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.TweenRotate( _endValue, _duration );
                        translator.Push(L, gen_ret);

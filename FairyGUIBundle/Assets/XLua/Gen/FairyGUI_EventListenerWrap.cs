        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<FairyGUI.EventDispatcher>(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
					...
					var gen_ret = new FairyGUI.EventListener(_owner, _type);
        ...
        static int _m_Call(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.Call(  );
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 2)) 
                {
                    object _data = translator.GetObject(L, 2, typeof(object));
                        ...
                        var gen_ret = gen_to_be_invoked.Call( _data );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_BubbleCall(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.BubbleCall(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 2)) 
                {
                    object _data = translator.GetObject(L, 2, typeof(object));
                        ...
                        var gen_ret = gen_to_be_invoked.BubbleCall( _data );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_BroadcastCall(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.BroadcastCall(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 2)) 
                {
                    object _data = translator.GetObject(L, 2, typeof(object));
                        ...
                        var gen_ret = gen_to_be_invoked.BroadcastCall( _data );
                        LuaAPI.lua_pushboolean(L, gen_ret);

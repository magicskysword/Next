...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 5, 25, 22);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Dispose", _m_Dispose);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Advance", _m_Advance);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "onExternalLoadSuccess", _m_onExternalLoadSuccess);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "onExternalLoadFailed", _m_onExternalLoadFailed);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_onExternalLoadSuccess(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.onExternalLoadSuccess( _texture );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_onExternalLoadFailed(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.onExternalLoadFailed(  );

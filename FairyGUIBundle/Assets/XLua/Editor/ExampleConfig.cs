...
public static class ExampleConfig
{
    ...
    //                 if (t != null)
    //                 {
    //                     return !t.Name.Contains("AnonymousType");
    //                 }
    //
    //                 return true;
    //             });
    ...
    //         return (returnTypes.Concat(paramTypes).Concat(fieldTypes)).Where(t => t.BaseType == typeof(MulticastDelegate) && !hasGenericParameter(t) && !delegateHasEditorRef(t) && !t.FullName.Contains("AnonymousType")).Distinct();
    //     }
    // }
    //--------------end 热补丁自动化配置-------------------------
